    ...
    <div class="container-produto">
        ...
        <form wire:submit.model="store">
            ...
            <div class="mb-3">
                ...
                <input type="text" wire:model="descricao" class="form-control" id="descricao" placeholder="Descrição do produto">
                @error('descricao')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" wire:model="quantidade_minima" class="form-control" id="quantidade_minima" placeholder="Estoque mínimo">
